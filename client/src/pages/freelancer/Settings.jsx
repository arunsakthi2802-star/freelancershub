...
import { Lock, Eye, EyeOff, Bell, UserX } from 'lucide-react';
  ...
  return (
    <div>
      <div style={{ marginBottom: 32 }}>
        ...
        <p className="page-subtitle">Configure your password, notifications, and privacy preferences.</p>
      </div>
      ...
      <div className="grid grid-2" style={{ gap: 24, alignItems: 'flex-start' }}>
        ...
        {/* Notifications Preferences & Deactivation */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <form onSubmit={handleSaveNotifications} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Receive job matching alerts by email</div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Enable browser push alerts for messages</div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Get real-time workspace chat signals</div>
                </div>
          ...
          <div className="card" style={{ padding: 24, border: '1px solid rgba(239,68,68,0.2)' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginBottom: 16 }}>
              Deactivating your account will take your profile offline and suspend any active bid proposals.
            </p>
